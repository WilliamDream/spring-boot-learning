...
//	    private static String elasticIps="http://127.0.0.1:9200";
	    ...
	    public static void insertBatch() {
			...
			objs.add(new Book("5", "张三", "张三是个Java开发工程师", 20, "2018-4-25 11:07:42"));
			objs.add(new Book("6", "李四", "李四是个测试工程师", 24, "1980-2-15 19:01:32"));
			objs.add(new Book("7", "王五", "王五是个运维工程师", 25, "2016-8-21 06:11:32"));
